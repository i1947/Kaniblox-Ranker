...
export const welcomeText = `${consoleYellow}Hey, thanks for using KaniBlox! If you run into any issues, please do not hesitate to join our support server: https://discord.gg/ezxP5BJuDb`;
